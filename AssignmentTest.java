...
/**
 * Assignment Test modified from Practice05 Test 
...
public class AssignmentTest {
	...
	protected SortFactory factory;      // This creates different sorting algorithms.
	...
	public AssignmentTest(int arraySize) {
		...
		factory = new SortFactory(false); // Do not use a default value for the algorithm name.
	}
